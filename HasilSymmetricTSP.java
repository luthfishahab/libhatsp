...
public class HasilSymmetricTSP {
    ...
    public static void main(String[] args) {
        ...
        for(int index = 0; index < file.length; index++) {
            ...
            String path = "D:\\2. Articles or Conference Papers\\05. LIBHATSP, A Library of Heuristic Algorithms for The Traveling Salesman Problem\\2. Data\\3. Data Full Matrix\\" + file[index];
            Library.LoadD(path);
